...
const King = (color) => {
    ...
    return (
        <div className="piece" id="king" draggable={true}>
            <svg  className={color} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
...
const Queen = (color) => {
    return (
        <div className="piece" id="queen" draggable={true}>
            <svg className={color} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512">
...
const Rook = (color) => {
    return (
        <div className="piece" id="rook"  draggable={true}>
            <svg className={color} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
...
const Bishop = (color) => {
    return (
        <div className="piece" id="bishop"  draggable={true}>
            <svg className={color} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512">
...
const Pawn = (color) => {
    return (
        <div className="piece" id="pawn" draggable={true}>
            <svg className={color} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 320 512">
...
const Knight = (color) => {
    return (
        <div className="piece" id="knight"  draggable={true}>
            <svg className={color} xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
...
export default function Pieces({piece,color}) {
    switch (piece) {
        case "king":
            return King(color)
        case "queen":
